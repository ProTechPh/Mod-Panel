...
const ACTION_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  'key.extend': { bg: 'rgba(234, 88, 12, 0.12)', text: 'var(--teal-2)', border: 'rgba(234, 88, 12, 0.3)' },
  'key.bulk_delete': { bg: 'rgba(239, 68, 68, 0.12)', text: 'var(--red)', border: 'rgba(239, 68, 68, 0.3)' },
  'user.update': { bg: 'rgba(234, 88, 12, 0.12)', text: 'var(--teal-2)', border: 'rgba(234, 88, 12, 0.3)' },
