 ...
 *
 * Actions:
 *   1. Expire pending orders older than 30 minutes (PayMongo sessions expire after ~1 hour)
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // 2. Delete expired orders older than 24 hours (1440 minutes)
    ...
    // 3. Delete failed orders older than 7 days (10080 minutes)
