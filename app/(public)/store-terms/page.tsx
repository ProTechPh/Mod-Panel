...
const STORE_TERMS = [
  ...
  },
  {
    ...
    content: [
      ...
      <span key="scam-contact">
        To report a scam or abandoned mod, please contact us directly on Telegram for investigation:{' '}
        <a href="https://t.me/CanKillYouForever" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
          https://t.me/CanKillYouForever
        </a>
      </span>,
    ],
  },
      ...
      <header className="sticky top-0 z-10 border-b border-border/50 bg-background/80 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">Store Terms</span>
          </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Store Terms of Service</h1>
          </div>
