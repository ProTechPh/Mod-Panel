...
const steps = [
  {
    ...
    description: 'Sign up in seconds. No complicated setup, just your username and you\'re ready.',
  ...
  },
  {
    ...
    title: 'Dominate',
    description: 'Launch the mod, activate your key, and experience the game like never before.',
    ...
    <section ref={sectionRef} className="relative py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          {/* Connecting lines */}
          <div className="hidden md:block absolute top-16 left-[calc(16.66%+2rem)] right-[calc(16.66%+2rem)] h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
          ...
          {steps.map((step, i) => (
            <div key={i} className="step-card flex flex-col items-center text-center gap-4">
              ...
              <p className="text-sm text-white/50 leading-relaxed max-w-xs">{step.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex justify-center mt-12">
          <Link
            ...
            className={cn(
              ...
              "hero-cta-primary rounded-full px-8 py-3.5 text-sm font-semibold shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 hover:scale-105 active:scale-95 transition-all"
            )}
          >
            Get Started Now
